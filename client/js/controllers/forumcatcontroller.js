myAppModule.controller('ForumCatController', ['$scope', '$rootScope', 'ForumCatFactory', '$location', function($scope, $rootScope, ForumCatFactory, $location){
    ...
    $scope.myComments = false;
    $scope.showComments = function(){
        if($scope.myComments == true){
            $scope.myComments = false;
        }
        else{
